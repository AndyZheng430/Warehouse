            ...
            steps{
                script{
                  withAWS(region: 'us-east-1', credentials: 'AWS_CREDENTIALS'){
                        ...
                        sh  'aws elasticbeanstalk create-application-version --application-name team8-backend --version-label 0.0.5 --source-bundle S3Bucket=\"team8-backend\",S3Key=\"backend-0.0.1-SNAPSHOT.jar\"'
